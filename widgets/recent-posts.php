...
class hs_recent_posts extends WP_Widget {

	function __construct() {
        $widget_ops = array( 'classname' => 'widget_hs_recent_posts', 'description' => __('Displays most recent posts with featured image and publishing date.', 'hs') );
        parent::__construct( 'widget_hs_recent_posts', __('Enhanced Recent Posts','hs'), $widget_ops );
    }
	...
	function widget($args, $instance) {
		...
		if (!empty($widget_title)) {
			...
			echo $before_title . esc_html__( 'Recent Posts', 'hs' ) . $after_title;
		}
		?>
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('widget_title'); ?>"><?php  _e('Title', 'hs'); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id('number_of_posts'); ?>"><?php _e('Number of posts to display', 'hs'); ?>:
...
register_widget('hs_recent_posts');
...
/*
function hs_posts_widget_registration() {
  unregister_widget('WP_Widget_Recent_Posts');
  register_widget('hs_recent_posts');
}
add_action('widgets_init', 'hs_posts_widget_registration');
*/